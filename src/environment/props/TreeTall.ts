...
export class TreeTall extends PropAsset {
	...
	static instancedMeshCount: number = 2000;
	...
	constructor(main: Main) {
		super(main, TreeTall.assetName, TreeTall.assetPositionY, TreeTall.instancedMeshAssetScale, TreeTall.instancedMeshCount);
	}
